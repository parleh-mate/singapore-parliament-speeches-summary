...
# job descriptions
speech_embeddings_job_description = (
    "singapore parliamentary speech embeddings batch job"
)
...
# get topics
topics_list = list(
    pd.read_csv("assets/topics_LDA.csv").query("include").topic_name.unique()
)
topics = ", ".join(topics_list)

# gpt model type
positions_model = "gpt-4.1-mini"
embedding_model = "text-embedding-3-small"
bills_model = "gpt-4.1-mini"
